...
public class MyReflect {
	...
	public void getPublicConstructor() throws Exception {
		...
		Person person = (Person)constructor.newInstance(101L,"zhangsan");
	...
	public void otherMethod() throws Exception {
		...
		System.out.println(Class.forName("City").isEnum());
		
		//判断当前的Class对象表示是否是接口
		System.out.println(personClass.isInterface());
		System.out.println(Class.forName("TestInterface").isInterface());
